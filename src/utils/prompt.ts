...
export const fixedNumberExamplesOf = (min: number, max: number, description: string) => `...<${getTerm('AT LEAST')} ${min}, ${getTerm('UP TO A MAXIMUM OF')} ${max}, ${getTerm('MUST')} be ${getTerm('BASED SOLELY ON')} ${description}>`;
